...
if __name__ == "__main__":
    ...
    person_name: str = "soichiro"
    recorded_wav_file_name: str= 'C:\\Users\\S2\\Documents\\デバイス作成\\2024測定デバイス\\swallowing\\original_data\\' + action_name +'_' + person_name + '_1.wav' # わけるwavファイルの名前
